...
var G__24727 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24727;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24728 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24728,ch);
...
if(("\\" === ch__$1)){
var ch_24729__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24729__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24729__$2);
} else {
}
...
var vec__24738 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24738,(0),null);
var start_column = cljs.core.nth.call(null,vec__24738,(1),null);
...
var G__24741 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24741;
continue;
}
}
...
var _STAR_read_delim_STAR_24742 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24742;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24743 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24743,(0),null);
var start_column = cljs.core.nth.call(null,vec__24743,(1),null);
...
var vec__24746 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24746,(0),null);
var end_column = cljs.core.nth.call(null,vec__24746,(1),null);
...
var vec__24749 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24749,(0),null);
var start_column = cljs.core.nth.call(null,vec__24749,(1),null);
...
var vec__24752 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24752,(0),null);
var end_column = cljs.core.nth.call(null,vec__24752,(1),null);
...
var vec__24755 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24755,(0),null);
var start_column = cljs.core.nth.call(null,vec__24755,(1),null);
...
var vec__24758 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24758,(0),null);
var end_column = cljs.core.nth.call(null,vec__24758,(1),null);
...
var sb = (function (){var G__24761 = (new goog.string.StringBuffer());
G__24761.append(initch);
...
var G__24763 = (function (){var G__24762 = sb;
G__24762.append(ch);

return G__24762;
})();
var G__24764 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24763;
ch = G__24764;
continue;
}
...
switch (G__24767) {
case "\\":
var G__24771 = (function (){var G__24768 = sb;
G__24768.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24768;
})();
var G__24772 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24771;
ch = G__24772;
continue;
...
break;
default:
var G__24773 = (function (){var G__24769 = sb;
G__24769.append(ch);

return G__24769;
})();
var G__24774 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24773;
ch = G__24774;
continue;
...
var vec__24775 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24775,(0),null);
var end_column = cljs.core.nth.call(null,vec__24775,(1),null);
...
var vec__24778 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24778,(0),null);
var column = cljs.core.nth.call(null,vec__24778,(1),null);
...
var line = cljs.core.nth.call(null,vec__24783,(0),null);
var column = cljs.core.nth.call(null,vec__24783,(1),null);
...
var vec__24788 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24788,(0),null);
var column = cljs.core.nth.call(null,vec__24788,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24793 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24793,(0),null);
var start_column = cljs.core.nth.call(null,vec__24793,(1),null);
...
var vec__24796 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24796,(0),null);
var end_column = cljs.core.nth.call(null,vec__24796,(1),null);
...
var G__24799 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24799,true,null,opts,pending_forms);
...
var G__24800 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24800)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24800)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24800)){
...
var _STAR_suppress_read_STAR_24801 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24801;
}});
...
var G__24802 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24802,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24802,rdr,first_line);
...
var G__24806 = matched;
var G__24807 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24806;
finished = G__24807;
continue;
} else {
...
var _STAR_suppress_read_STAR_24808 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24808;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24809 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24810 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24810,"(");
...
var G__24811 = (i + (1));
var G__24812 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24809;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24813 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24813);
...
var G__24816 = cljs.core.next.call(null,s);
var G__24817 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24816;
key_vals = G__24817;
continue;
} else {
...
var gensym_env24821 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24821;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24822 = token;
var G__24822__$1 = (((G__24822 == null))?null:cljs.core.subs.call(null,G__24822,(1)));
var G__24822__$2 = (((G__24822__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24822__$1));
var G__24822__$3 = (((G__24822__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24822__$2));
var G__24822__$4 = (((G__24822__$3 == null))?null:cljs.core.symbol.call(null,G__24822__$3));
if((G__24822__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24822__$4);
}
})():(function (){var G__24823 = token;
var G__24823__$1 = (((G__24823 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24823));
if((G__24823__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24823__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24834,reader){
...
var eof = cljs.core.get.call(null,map__24835__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___24843 = arguments.length;
var i__4500__auto___24844 = (0);
while(true){
if((i__4500__auto___24844 < len__4499__auto___24843)){
args__4502__auto__.push((arguments[i__4500__auto___24844]));

var G__24845 = (i__4500__auto___24844 + (1));
i__4500__auto___24844 = G__24845;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24841){
var G__24842 = cljs.core.first.call(null,seq24841);
var seq24841__$1 = cljs.core.next.call(null,seq24841);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24842,seq24841__$1);
});


//# sourceMappingURL=reader.js.map?rel=1551032927137
