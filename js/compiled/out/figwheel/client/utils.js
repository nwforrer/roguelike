...
return (new CustomEvent(event_name,(function (){var obj28516 = {"detail":data};
return obj28516;
})()));
} else {
...
var f = (function (){var pred__28523 = cljs.core._EQ_;
var expr__28524 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28523.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28524))){
return ((function (pred__28523,expr__28524){
return (function (p1__28517_SHARP_){
return console.warn(p1__28517_SHARP_);
});
;})(pred__28523,expr__28524))
} else {
if(cljs.core.truth_(pred__28523.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28524))){
return ((function (pred__28523,expr__28524){
return (function (p1__28518_SHARP_){
return console.debug(p1__28518_SHARP_);
});
;})(pred__28523,expr__28524))
} else {
if(cljs.core.truth_(pred__28523.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28524))){
return ((function (pred__28523,expr__28524){
return (function (p1__28519_SHARP_){
return console.error(p1__28519_SHARP_);
});
;})(pred__28523,expr__28524))
} else {
return ((function (pred__28523,expr__28524){
return (function (p1__28520_SHARP_){
return console.log(p1__28520_SHARP_);
});
;})(pred__28523,expr__28524))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28527){
...
var eval_fn = cljs.core.get.call(null,map__28528__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28530_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28532,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1551032929284
